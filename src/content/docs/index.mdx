...
In this project, the content is organized in books. Select your book and study. Authors of these books is Gemini Pro (Bard AI), using prompt engineering. We ask questions in order using a simple context and create a long page for infinite scroll. You could use AI yourself, but we have ask the questions so you don't have to. We publish response under GPL license. 
